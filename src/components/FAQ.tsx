...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: `I'm based in ${CONTACT_INFO.timezone}. I'm flexible with working hours and can accommodate different timezones for meetings and collaboration. I typically respond to messages within ${CONTACT_INFO.responseTime.toLowerCase()}.`
  },
  {
  ...
  },
  {
    ...
    answer: "I specialize in Kotlin, Jetpack Compose, Clean Architecture, Coroutines, and modern Android development. I have extensive experience with payments (Visa Tokenization), real-time systems (WebSocket, gRPC), hardware integration (Bluetooth, Android Automotive), and Wear OS. See my Expertise section for a complete list."
  },
  {
